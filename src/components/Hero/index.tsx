  ...
  return (
    ...
    */}
        ...
        <div className="relative mx-auto mt-16 max-w-5xl pointer-events-none">
          <motion.div style={{ y: y1 }} className="absolute -top-24 -left-32 w-56 sm:-top-48 sm:-left-48 sm:w-96">
            <Image
          ...
          <motion.div style={{ y: y2 }} className="absolute w-44 sm:-top-64 sm:-right-48 -top-24 -right-24 sm:w-96">
            <Image
            src="/images/hero/hero-image.jpg"
            alt="Hero 2"
              className="rounded-3xl shadow-2xl"
