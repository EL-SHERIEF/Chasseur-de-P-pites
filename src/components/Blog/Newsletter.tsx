    ...
    >
      ...
      <form>
        ...
        <input
          type="submit"
          value="Subscribe Now"
          className="mb-4 h-[50px] w-full cursor-pointer rounded-md bg-secondary text-center text-sm font-medium text-primary transition duration-300 ease-in-out hover:bg-opacity-90"
        />
      </form>
